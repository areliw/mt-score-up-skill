...
- **content-creator-copyright** — เส้นลิขสิทธิ์คอนเทนต์ให้ความรู้: เพลง (คลังแพลตฟอร์ม/CC flavor) · อินโฟกราฟิก (redraw ไม่ลอกดีไซน์) · Content ID claim vs strike · **เครดิต≠อนุญาต · ปลอดภัยแพลตฟอร์มเดียว≠ทุกที่** · PII เคสคนไข้ (de-identified ยังเดาตัวได้)
...
- **interprofessional-communication-judgment** — คุยกับสหวิชาชีพแนวราบด้วย "ภาษาเขา": หมอ=ผลกระทบต่อคนไข้ (ไม่ใช่ภาษา vendor/แล็บ) · พยาบาล=ผูกการ manage คนไข้ + สร้างสัมพันธ์ · ห้องยา/TDM/PGx=ภาษายา + **golden-period** (เจอปัญหารีบแจ้งตามสาย เร็ว>ครบ ก่อนพ้นหน้าต่างที่ยังแก้ง่าย) — คู่แนวราบของ report-up
- **receiving-review-judgment** — รับ feedback (code review/รีวิวเปเปอร์/หัวหน้าติ/codex-CI) ให้เป็น: triage **take/drop/push-back** · เมื่อไหร่แย้ง (ไม่ caved/ไม่ ego) + disagree-and-commit **ยกเว้น correctness/security/legal** · อ่าน nit ที่ชี้ root · feedback จาก AI = **verify ก่อน apply** ไม่เชื่อดิบ

...
- **ตั้งราคาของตัวเอง = คิด true unit cost ก่อน:** `ต้นทุนผันแปร/หน่วย + ต้นทุนคงที่เฉลี่ย/หน่วย (fixed ÷ volume)` — กับดักคลาสสิก (ร้านอาหารดังที่เจ๊งเพราะคิดต้นทุนแค่วัตถุดิบ): นับแต่ **ต้นทุนตรง** ลืม hidden cost — **คนแบบเต็ม (เงินเดือน+สวัสดิการ+วันลา/คนแทน), ค่าเช่า+น้ำ+ไฟ+เน็ต, ค่าซ่อม/สัญญาบริการ, ค่าเสื่อมเครื่อง** — ที่รวมกันอาจ "เท่า" ต้นทุนตรง → ตั้งราคาต่ำกว่าทุนจริงโดยไม่รู้ตัว (ยิ่ง volume ต่ำ fixed/หน่วยยิ่งสูง). เช็ค **ราคา ≥ true unit cost แม้ไม่หวังกำไร** (โยง `lab-clinic-business-judgment` สำหรับ cost stack แล็บโดยเฉพาะ)
...
- 🚫 **ตั้งราคาจากต้นทุนตรงอย่างเดียว ลืม fixed/overhead** — hidden cost (คนเต็ม/ค่าเช่า/ค่าซ่อม/ค่าเสื่อม) อาจ "เท่า" ต้นทุนตรง → ขายต่ำกว่าทุนจริงทั้งที่ "กำไร" ดูบวก (โยง `lab-clinic-business-judgment`)

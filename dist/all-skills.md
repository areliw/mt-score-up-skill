...
> **กฎข้อ 1:** อย่าเพิ่งเสนอวิธีแก้ก่อน **ทำให้บั๊กเกิดซ้ำได้** (reproduce) — repro คือ*ทางที่ดีสุด* เพราะวัด fix ได้ชัด. ⚠️ แต่บั๊กที่ reproduce ไม่ได้ (heisenbug/prod-only/intermittent) **ยัง diagnose ได้จาก log/core dump/trace/static analysis** — repro เป็น *เป้าหมายแรก* ไม่ใช่ *เงื่อนไขเดียว*. อย่ากระโดดเดาสาเหตุลอยๆ.
...
| 3. ตั้ง+หักล้างสมมติฐาน | เขียน 3-5 อันแบบ falsifiable แล้วลองล้มก่อน | รอดการล้ม = **น่าเชื่อสุด** (ยืนยันเมื่อ fix แล้วบั๊กหายตามทำนาย) |
...
- **รัน disproof ก่อน:** ออกแบบการทดลองที่ *ล้ม* สมมติฐานได้เร็วสุด — รอดการล้ม = **น่าเชื่อสุด** (ยังไม่ใช่พิสูจน์ — ยืนยันจริงเมื่อ fix แล้วบั๊กหายตามที่ทำนาย), ตาย = ตัดทิ้ง

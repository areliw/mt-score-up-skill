...
- **📊 Data-verified (6-path market research + adversarial verify, 2026-06-24) — ประตูที่ "เสียบได้ตอนนี้จริง" มีแค่ 2 · ที่เหลือเป็น "สะพาน":** แม้คอขวด ขรก. จริง แต่ตำแหน่ง bench *รวม* ก็เปิดน้อยมากเทียบจบใหม่หลักพัน/ปี → musical chairs (⚠️ *ตัวเลขเป๊ะไม่มีหลักฐานทางการ — เคยมีคนเล่าว่าหลักสิบ/เดือน เป็นการประมาณ ไม่ใช่สถิติ; verify เลขปัจจุบันเอง*) → **non-bench = primary path สำหรับคนส่วนใหญ่ ไม่ใช่ fallback**:
  - **🟢 #1 เครือแล็บเอกชนใหญ่ / แล็บเอกชน:** base ~16,000-22,000 (*ช่วงจากประกาศช่วงหนึ่ง — verify ปัจจุบันเอง ประกาศเปลี่ยน/หมดอายุได้*) · value-capture ต่ำสุด = ใช้เป็น **runway หาเงิน + ไม่ให้ gap** (**Track A**)
  - **🟢 #2 IVD distributor Sales/Application Specialist:** base ~14,000-17,000 + commission (*ประมาณ — verify เอง*) · value-capture สูงสุดในกลุ่มที่เข้าได้ + ทน AI · **เล็ง distributor/ตัวแทนจำหน่ายไทยระดับกลาง (มักรับจบใหม่) ไม่ใช่ principal แบรนด์ใหญ่ (มักต้องประสบการณ์หลายปี)** · เตรียม product story จาก internship (**Track B** — Fork 2)
  - **🟠 สะพาน (เป้าปี 2-3 ไม่ใช่ first job — ประตู opaque/ต้อง bridge 1-2 ปี):** genomics/NGS (ตลาดเล็ก ~10 ตำแหน่ง แต่ shortage จริง) · CRA/CRC (เข้าทาง CRC รพ. ไม่ลง job board) · regulatory/QA (เข้าทาง QA officer ก่อน lateral เป็น RA) · IVF/embryology (pool <20 ต้องมี exp) → **เก็บ prerequisite ตั้งแต่ตอนนี้** (NGS internship/GCP cert/ATE course) ระหว่างทำ Track A+B
  - **กฎ:** Track A (เงิน) + Track B (value) **ขนานกัน** · อย่า all-in สะพานก่อนมี bridge · แหล่ง+รายละเอียด: `synthesis/value-capture-mt-labor-market.md` §Update 2026-06-24

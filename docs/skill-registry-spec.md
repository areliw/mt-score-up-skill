...
> ตัวเลขในหัวเรื่องนี้คือ stress-test ไม่ใช่ KPI: ถ้าโครงรองรับ 1000 ได้ มันก็รองรับ 94 ได้แบบไม่เน่า.
...
คลังตอนนี้ 94 ตัว ยังคุมด้วยตา + agent audit ไหว. ที่ 200–1000 ตัว สามอย่างพังพร้อมกัน:

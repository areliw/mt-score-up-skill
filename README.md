...
- **0 regression อันตราย** ใน 53 ตัว — ไม่มีสกิลไหนทำให้ตอบ "พังลง" <sub>(eval รันบน 53 สกิล ณ ตอนนั้น; ใน +34 ที่เพิ่มภายหลัง — **8 ตัว v0.6.0 ผ่าน spot-A/B แล้ว: 8 tie · 0 regression** [`eval/round4`](./eval/round4-new-skills.md); อีก ~26 (v0.4–0.5) ผ่าน design review แต่ยังไม่ A/B)</sub>

...
- **⚠️ "รอบรรจุ" ไม่เหมือนกันทุกสังกัด — เช็คกลไกของหน่วยตัวเองก่อนตัดสินใจรอ (เคสคอมมูฯ — verify เอง):** **สธ.** หลายรอบ/หลายสายใช้แบบ **ขึ้นบัญชี-เรียกตามลำดับ** ที่ *มัก* ได้อยู่หน่วยเดิม/ใกล้เดิม — *แต่ก็มีคัดเลือก/เรียกไปเลือกสถานที่บรรจุ ขึ้นกับกรอบว่าง/รอบ/ลำดับ ไม่ใช่ "ได้ที่เดิม" เสมอ* · ขณะที่ **บางสังกัด/บางรอบ (เช่น รพ.สังกัดกลาโหม/รพ.ค่าย)** อาจใช้ **กลไกสอบส่วนกลาง/จัดสรรตามกรอบ** → แม้สอบผ่าน (ก) อาจถูกจัดไปลงแผนกที่ไม่ใช่แล็บ (ข) ต้องรอ รพ.ที่มีตำแหน่งว่าง = **โอกาสได้กลับ รพ.เดิมอาจน้อย** · นัย: คนทำงานหลายปีในสังกัดแบบหลัง **อาจรอบรรจุที่เดิมไปนานโดยไม่ได้บรรจุ** → รู้กลไกก่อน แล้วค่อยชั่ง "รอ vs ขยับ" (ระเบียบ/ตำแหน่งว่างแต่ละสังกัดเปลี่ยน — verify กับ HR/ฝ่ายกำลังพลของหน่วยเอง) · ⚠️ **ทำไม MT ในกลาโหมบางที่ถึงตัน (เคสเล่า — verify ประกาศหน่วยนั้น):** มีเคสว่าหมอ/เภสัช/พยาบาล *บางหน่วย* มีช่องสอบ**ภายใน** ขณะที่บางสายวิชาชีพ (รวม MT) ต้องไปช่องทาง**ส่วนกลาง/สอบ ยศ.** (อาจมีแต้มพิเศษตามอายุงาน) แทน — เป็นเหตุที่ลูกจ้างหลายปี "บรรจุที่เดิมไม่ได้สักที" · ประตูอื่น: **รพ.สังกัด กทม.** *บางรอบ/บางตำแหน่ง* มีสอบ ขรก. · มอง 2 ด้าน — ช่องส่วนกลางช่วยลด bias เลือกพวกพ้อง vs อาจตัดคนทำงานดีแต่สอบไม่เก่ง

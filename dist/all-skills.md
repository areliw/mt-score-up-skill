...
- **📊 Data-verified (6-path market research + adversarial verify, 2026-06-24) — ประตูที่ "เสียบได้ตอนนี้จริง" มีแค่ 2 · ที่เหลือเป็น "สะพาน":** แม้คอขวด ขรก. จริง แต่ bench *รวม* ก็ ~5:1 (เปิดราว 20-30 ตำแหน่ง/เดือนที่ aggregate ได้ vs จบใหม่ ~1500-1600/ปี) → **non-bench = primary path สำหรับคนส่วนใหญ่ ไม่ใช่ fallback**:
  - **🟢 #1 แล็บเอกชน/เครือแล็บ (N Health ฯลฯ):** base ~16,000-22,000 `[✓src jobbkk]` · value-capture ต่ำสุด = ใช้เป็น **runway หาเงิน + ไม่ให้ gap** (**Track A**)
  - **🟢 #2 IVD distributor Sales/Application Specialist:** base ~14,000-17,000 + commission `[~est eduzones]` · value-capture สูงสุดในกลุ่มที่เข้าได้ + ทน AI · **เล็ง distributor ไทย (Biomed Diagnostics/Meditop รับจบใหม่) ไม่ใช่ principal (Roche/Sysmex ต้อง 6-8 ปี)** · เตรียม product story จาก internship (**Track B** — Fork 2)

...
>
> **Scope.** n=53 = the library **at the time this eval ran** (v0.2 era). The library is now **88 skills** — the +34 added by v0.6.0 (v0.4.0–v0.6.0) passed design review but have **not** had a weak-model A/B yet (see `CHANGELOG.md`); the newest skill `git-workflow-judgment` (#88, added after) is likewise **not** A/B-screened. This scorecard is not a claim about those 35.

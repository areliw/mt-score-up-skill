...
reviewed: 2026-05-31
status: draft
disclaimer: "ช่วยลด+จับการมั่วของ AI — ลดได้ ไม่ได้กันหมด 100% เรื่องการแพทย์/สำคัญต้องยืนยันกับแหล่ง authoritative และมนุษย์เสมอ"
---
...
> LLM สร้างข้อความที่ "ฟังดูน่าจะใช่" ไม่ใช่ "จริงที่ตรวจแล้ว" — มันแต่งตัวเลข ชื่อ paper DOI ค่า reference ได้เนียนและ**มั่นใจ**. กันไม่ได้ 100% เป้าหมายคือ (1) ลดโอกาสมั่ว (2) **รู้ว่าเมื่อไหร่ต้องไม่เชื่อแล้วไปตรวจ**. ความมั่นใจของ AI ≠ ความถูกต้อง
...
---
*ช่วยลด+จับการมั่วของ AI — ลดได้ ไม่ได้กันหมด 100% เรื่องการแพทย์/สำคัญต้องยืนยันกับแหล่ง authoritative และมนุษย์เสมอ*

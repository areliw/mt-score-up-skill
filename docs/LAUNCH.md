...
> หลักคิดเดียวที่ถือทั้งหน้า: **แคบก่อน กว้างทีหลัง** เพราะของยัง `draft` ทั้ง 88 ตัว ยังไม่ผ่าน clinical peer-review — ปล่อยกว้างทันทีแล้วมี error คลินิกหลุด = เสีย credibility ทั้งโปรเจกต์ในครั้งเดียว แก้คืนยาก

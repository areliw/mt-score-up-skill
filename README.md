...
| [phi-data-handling](./skills/phi-data-handling.md) | ข้อมูลคนไข้ในงาน MT: de-identify ให้จริง (quasi-identifier/small cell) · ที่ไหนได้-ไม่ได้ · retention · ใส่ AI ปลอดภัย |
...
```
mt-score-up-skill/
├── skills/        # ★ 83 สกิล — copy (แช่แข็ง) หรือโหลดสดผ่าน INDEX.md (auto-sync)
...
├── docs/          # Vision, setup + how-we-audit/eval/maintain + EXPANSION-PLAN (T-shaped)
...
- **0 regression อันตราย** ใน 53 ตัวที่ A/B แล้ว — ไม่มีสกิลไหนทำให้ตอบ "พังลง" <sub>(eval รันบน 53 สกิลรุ่นแรก; สกิลรุ่นหลัง **30 ตัว** — รวม T-shaped expansion wave 1–5 — ผ่าน critical review (ดู `docs/how-we-audit.md`) แล้วแต่ **ยังไม่ A/B** และยัง `status: draft`; เนื้อหา clinical รอ peer-review)</sub>

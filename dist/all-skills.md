...
### Fork 1B — อย่าวางแผน retake จาก "กฎคะแนน" ที่ได้ยินต่อๆ กัน — ยืนยันทางการก่อน
- **สถานการณ์:** สอบไม่ผ่านบางส่วน แล้วต้องตัดสินใจว่ารอบหน้า **retake วิชาไหน / ปล่อยวิชาไหนไว้** — การตัดสินนี้พึ่ง **กฎคิดคะแนนของรอบนั้น** ทั้งหมด (ผ่านที่คะแนนรวมหรือมีขั้นต่ำรายวิชา · สะสม/carry-over คะแนนข้ามรอบได้ไหม · คะแนนเก่าอยู่กี่ปี)
- ⚠️ **กับดักหลัก:** กฎพวกนี้ **คนในคอมมูฯ เล่าไม่ตรงกันเอง** (บ้างว่าเอาคะแนนสูงสุดต่อวิชาบวกรวมให้ถึงเกณฑ์รวม ไม่ต้องผ่านรายวิชา · บ้างเข้าใจอีกแบบ) **และเปลี่ยนได้ตามประกาศแต่ละรอบ** → วาง retake จาก "เลข/กฎที่ได้ยินมา" = เสี่ยงพลาดรอบ/เสียปี
- **ทำให้ถูก:** ก่อนตัดสินใจปล่อย/เก็บวิชา → อ่าน **ประกาศ/ระเบียบการสอบของสภาเทคนิคการแพทย์รอบนั้น + score report ของตัวเอง** ให้ชัดว่า (1) ผ่านที่คะแนนรวม หรือมีขั้นต่ำรายวิชา (2) สะสม/carry-over ได้ไหม + อายุกี่ปี → **ถามเจ้าหน้าที่สภาฯ โดยตรงถ้าไม่ชัด** อย่าเดาจากโพสต์

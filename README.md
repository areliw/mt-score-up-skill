...
- **0 regression อันตราย** ใน 53 ตัว — ไม่มีสกิลไหนทำให้ตอบ "พังลง" <sub>(eval รันบน 53 สกิล ณ ตอนนั้น; อีก 34 ตัวที่เพิ่มภายหลัง (v0.4.0–v0.6.0) ผ่าน design review แล้วแต่ยังไม่ A/B)</sub>

...
> เงินไม่ใช่เรื่องของ "ลงทุนตัวไหนดี" เป็นอันดับแรก — แต่คือ **ลำดับ** (เคลียร์หนี้แพง → เงินสำรอง → ค่อยลงทุน) + **กับดักที่ดูดเงิน** (การันตีผลตอบแทน=scam, sunk-cost, ลืมงบกระแสเงินสด). skill นี้เก็บสองอันนั้น
...
- บทเรียน: Theranos (เชื่อ story ไม่เชื่อ data), Fyre (hype > สาร) → **ขอ data/track record ที่ audit ได้ ก่อนเชื่อ narrative**
...
- 🚫 **"การันตีผลตอบแทน" = scam** — ไม่มี risk-free สูง (ดู `digital-judgment` ด้วย)

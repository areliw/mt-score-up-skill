...
reviewed: 2026-05-31
status: draft
disclaimer: "เป็นระบบช่วยจัดระเบียบ — ก่อนลบ/ย้ายไฟล์จำนวนมาก สำรอง (backup) ก่อนเสมอ"
---
...
- ของแต่ละประเภทมี **ที่อยู่เดียว** เท่านั้น (เช่น งานวิจัยทั้งหมด → `02_Research/` ที่เดียว)
...
- รูปแบบเดียว: **`YYYY-MM-DD_เรื่อง_v1`** เช่น `2026-05-31_R2R-stats_v2.xlsx`
- ❌ เลิก: `เอกสาร(3).pdf`, `final_REAL_ใช้อันนี้.docx`
- วันที่ขึ้นต้น = เรียงตามเวลาอัตโนมัติ + search เจอด้วยคำเดียว

### กฎ 3 — triage ทุกสัปดาห์ (อย่าให้ inbox กลายเป็นสุสาน)
- 10 นาที/สัปดาห์: เปิด **Downloads + Desktop + โฟลเดอร์ inbox** → ของทุกชิ้น **ย้ายเข้าบ้าน / ลบ** ห้ามค้าง
...
*ระบบนี้เป็นเครื่องมือช่วยจัดระเบียบ ไม่ใช่ระบบสำรองข้อมูล — ก่อนลบ/ย้ายไฟล์จำนวนมาก สำรอง (backup) ก่อนเสมอ และอย่าลบข้อมูลดิบวิจัย เวชระเบียน หรือเอกสารกฎหมายจนกว่าจะแน่ใจ 100%*

...
title: โค้ชอ่านผลแล็บข้ามแขนง — ร้อยค่าให้เป็น 1 วินิจฉัย (Clinical Correlation Judgment)
type: ADVISE
needs: any
...
# โค้ชอ่านผลแล็บข้ามแขนง — ร้อยค่าให้เป็น 1 วินิจฉัย

ตัวช่วยอ่านผลแล็บข้ามแขนง (hema + chem + micro + immuno + blood-bank) แล้วร้อยเรื่องเป็น 1 การวินิจฉัย — เน้น **วิธีคิดเชิงวินิจฉัย + กับดักที่ทำให้พลาด** ไม่ใช่ท่องค่า

> ผลแล็บข้ามแขนงคือจุดที่ "ตัวเลขลอยไม่มีคนไข้ = อ่านผิด" — skill นี้จึงนำด้วยการ **เช็ค clinical context + pre-analytical ก่อนเชื่อค่า** แล้วจึงร้อยค่าผิดทุกตัวให้อธิบายได้ด้วยกลไกเดียว
...
- เตือนตัวเองก่อน lock diagnosis: เช็ค trap list ด้านล่าง
...
### กฎเหล็กก่อนวินิจฉัยเสมอ — ถาม/เช็ค 4 อย่าง
...
- **ทุกค่าผิด อธิบายได้ด้วยกลไกเดียว = วินิจฉัยแน่น**

...
- **จะรับงาน part-time เดินเครื่อง POCT/แล็บใน "คลินิกแพทย์ (คลินิกเวชกรรม)"** — อยู่ใต้ใบหมอถูกต้องเลยไหม / คลินิกต้องขึ้นทะเบียนหมวดอะไร / ใครออกใบรับรองแพทย์ได้ (Fork 10)
...
### Fork 10 — "รับงาน part-time เดินเครื่อง POCT/แล็บใน 'คลินิกแพทย์ (คลินิกเวชกรรม)'": ใบเวชกรรมของหมอ *ไม่* คลุมงานแล็บ MT อัตโนมัติ (เคสคอมมูฯ — verify ตัวบท/สภาฯ/สสจ.)
> **verdict:** หมอชวนไปนั่งเดินเครื่อง POCT/แล็บที่ "คลินิกเวชกรรม" ของเขา **ไม่ได้แปลว่าถูกต้องอัตโนมัติเพราะ "อยู่ใต้ใบหมอ"** — คนละแกนกับ Fork 2 (หัตถการทำเป็นไหม) และต่อยอดจาก Fork 9 (แกน พ.ร.บ.สถานพยาบาล): คราวนี้ประเด็นอยู่ที่ **ประเภท/หมวดใบอนุญาตของ *ตัวคลินิก* + คุณถูกขึ้นทะเบียนเป็นใคร** ไม่ใช่แค่ "เจาะ/เดินเครื่องเป็นไหม"
- **แกนที่ต้องแยก (โยง Fork 9):** ใบ *ประกอบวิชาชีพ* (Fork 1/2 — ตัวคุณทำหัตถการ/รับรองผลได้) ≠ ใบ *ประกอบกิจการสถานพยาบาล* (พ.ร.บ.สถานพยาบาล — สถานที่เปิดให้บริการอะไรได้) · **ใบเวชกรรมของแพทย์โดยหลักคุม *บริการเวชกรรม*; การเปิดให้ *บริการเทคนิคการแพทย์* บนสถานที่นั้นโดยหลักเป็นบริการอีกหมวดที่กฎหมายกำกับแยก** → *แพทย์ถือใบประกอบเวชกรรม ไม่ได้แปลว่าสถานพยาบาลของเขาเปิดบริการแล็บ MT ได้เองอัตโนมัติ*
- **fork หลัก — ใคร "เป็นคนทำ" การตรวจ:**
  - **แพทย์ตรวจ/อ่านผล POCT เอง** ในฐานะส่วนหนึ่งของการตรวจรักษาผู้ป่วยของตน = อีกกรณี — โดยหลักอยู่ในขอบเขต *เวชกรรม* ของแพทย์เอง (POCT ประกอบการวินิจฉัย) → *ไม่ใช่ประเด็นเดียวกับการเปิด "บริการเทคนิคการแพทย์" บนสถานพยาบาล*
  - **MT เป็นคนทำ/วิเคราะห์/รับรองผลแล็บบนสถานที่นั้น** = เปิด *บริการเทคนิคการแพทย์* → **มีเสียงในคอมมูฯ ว่าโดยทั่วไปต้องปรับ/ขึ้นทะเบียนหมวดเป็น "สหคลินิก" (เวชกรรม + เทคนิคการแพทย์ ร่วมกัน)** โดยมี MT ขึ้นทะเบียนเป็น **ผู้ดำเนินการด้านเทคนิคการแพทย์** — *ชื่อหมวด/ประเภท/เงื่อนไขต้อง verify กับ พ.ร.บ.สถานพยาบาล + สสจ. พื้นที่ (อย่าฟันธงเลขข้อ/ชื่อหมวดเอง)*
  - ⚠️ **ไม่ใช่ทุก POCT = ต้องเป็นสหคลินิกเสมอ (เส้นแบ่งฟัซซี่):** ระดับ/ความซับซ้อนของ POCT ต่างกัน — การตรวจ near-patient แบบง่าย (เช่น กลูโคสปลายนิ้ว/ชุดตรวจ rapid) ที่ทำ *ประกอบการตรวจรักษาของแพทย์เอง* **อาจ**อยู่คนละเกณฑ์กับการเปิดบริการแล็บ MT เต็มรูป · *"แค่ไหนถึงนับเป็น 'บริการเทคนิคการแพทย์' ที่ต้องขึ้นหมวด" เป็นเส้นที่ต้อง verify กับ สสจ. เป็นรายกรณี — อย่าฟันธงเองทั้ง "แตะเครื่อง = ต้องสหคลินิกทันที" และ "POCT ง่ายๆ ไม่ต้องสนกฎหมายเลย"*
- 🔑 **"ผู้ดำเนินการ" ≠ "ไปนั่งเดินเครื่อง part-time เฉยๆ":** การถูกวางเป็น *ผู้ดำเนินการด้านเทคนิคการแพทย์* ของสถานพยาบาล โดยหลักมาพร้อม *หน้าที่/ความรับผิดตามกฎหมายสถานพยาบาล* (คุมมาตรฐานบริการส่วนนั้น) — รวมถึงช่วงเวลาที่คุณไม่ได้อยู่หน้างานด้วยหรือไม่? → **รู้ก่อนเซ็น/ก่อนให้เขาเอาชื่อไปขึ้นทะเบียน** ว่ากำลังรับบทอะไร ครอบคลุมแค่ไหน (โยง Fork 6 ความรับผิด, Fork 8 การถูกอ้างชื่อหลังพ้นงาน)
- 🚫 **เส้นขอบเขต "ออกเอกสารอะไรได้": ใบรายงานผลแล็บ ≠ ใบรับรองแพทย์** — บริการเทคนิคการแพทย์/MT *วิเคราะห์ + รายงานผล + ออกใบรายงานผลแล็บ* ให้แพทย์/ผู้รับบริการได้ในขอบเขตวิชาชีพ **แต่โดยหลัก *ออก/ขายใบรับรองแพทย์ (เช่น ใบรับรองแพทย์ 5 โรค) ไม่ได้* — นั่นเป็นขอบเขต *เวชกรรม* (ต้องแพทย์เป็นผู้ตรวจ/รับรอง)** · ⚠️ อย่าให้คลินิกใช้ MT/แล็บเป็นช่องออกใบรับรองแพทย์แทนแพทย์ = นอกขอบเขต + เสี่ยงผิดทั้งวิชาชีพและสถานพยาบาล *(ขอบเขตออกเอกสาร verify ข้อบังคับสภาเทคนิคการแพทย์ + พ.ร.บ.วิชาชีพเวชกรรม/เทคนิคการแพทย์)*
- 🔎 **เช็คก่อนรับงาน (อย่าตอบสุดทาง):** ไม่ใช่ "หมอชวน = ผิดแน่" และไม่ใช่ "อยู่ใต้ใบหมอ = ปลอดภัยแน่" — จุดที่ต้องเคลียร์ก่อนตกลง: (ก) คลินิกขึ้นทะเบียนหมวดอะไร / ต้องปรับเป็นสหคลินิกไหม → **ถาม สสจ. พื้นที่** (ข) คุณถูกวางเป็น *ผู้ดำเนินการ* หรือ *ผู้ปฏิบัติ* และรับผิดแค่ไหน (ค) ใครรับรองผล/ใครกำกับ POCT ตอนคุณไม่อยู่ (ง) เงื่อนไข part-time ทับกับงานประจำ/สัญญาเดิม/ข้อห้ามแข่งขันไหม (โยง Fork 4 IP·สัญญา, `mt-career-judgment`)
- หลัก: **"อยู่ใต้ใบหมอ" ไม่ใช่ใบผ่านทางของงานแล็บ MT** — เปิดบริการเทคนิคการแพทย์บนสถานพยาบาล = เรื่อง *หมวดใบอนุญาตกิจการ* (พ.ร.บ.สถานพยาบาล) + *ผู้ดำเนินการ* + *ขอบเขตออกเอกสาร* → verify หมวด/เงื่อนไขกับ สสจ. + สภาเทคนิคการแพทย์ ก่อนตกลง ไม่ใช่เชื่อว่า "หมอ cover ให้หมด"
...
- 🚫 **เชื่อว่า "รับงานแล็บ/POCT ในคลินิกแพทย์ = อยู่ใต้ใบเวชกรรมของหมอ ปลอดภัยอัตโนมัติ"** — ใบเวชกรรมโดยหลักไม่คลุมการเปิด *บริการเทคนิคการแพทย์*; คลินิกที่เปิดบริการแล็บ MT โดยทั่วไปอาจต้องปรับหมวดเป็น *สหคลินิก* + ขึ้นทะเบียน MT เป็น *ผู้ดำเนินการด้านเทคนิคการแพทย์*; และแล็บ/MT ออก *ใบรับรองแพทย์* แทนเวชกรรมไม่ได้ (ออกได้แค่ใบรายงานผลแล็บ) — verify หมวด/เงื่อนไขกับ สสจ./สภาฯ ก่อนตกลง (Fork 10)

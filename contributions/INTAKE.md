...
- 🖼️ **ส่งมาเป็นรูป/ถ่ายโน้ตมือ:** สแกน **ฉากหลัง + ขอบภาพ** (จอ LIS, sticker, ไวท์บอร์ดที่มี HN/ชื่อ) + **ลบ EXIF/พิกัด** ก่อนนำขึ้น — guard ข้อความจับ PHI ในรูปไม่ได้
...
ก่อนสร้างใหม่ **เช็คเสมอ** ว่ามีตัวที่ทับ domain อยู่แล้วไหม (คลังมี 88 ตัว — ทับกันง่าย).

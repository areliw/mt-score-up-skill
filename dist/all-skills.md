...
- *worked example: โพสต์ไวรัล "Karpathy เข้า Anthropic" — prior (cutoff ม.ค. 2026: เขาทำ Eureka Labs อิสระ) ชี้ "น่าจะแต่ง" แต่ตรวจหลายแหล่งทางการ (TechCrunch/CNBC/ทวีตเจ้าตัว) ตรงกัน → **จริง** (19 พ.ค. 2026 ทีม pre-training); ถ้าฟันธงปลอม = spread ข้อมูลผิดด้วยน้ำเสียงมั่นใจ*
...
- ⏱️ golden-period นานแค่ไหน = **ไม่มีสูตร ใช้ gut feeling** — ยิ่งเร็วยิ่งคลี่คลายง่าย/เสียหายน้อย; พ้น window = บานปลาย+โดนจำยาว → หาจุดแล้วรีบแก้ ไม่รอมั่นใจ 100%
...
- 🔑 **"แพทย์สั่ง ≠ ขยายขอบเขตวิชาชีพ"** — คำสั่งแพทย์บอก *ตรวจอะไร/รักษาอะไร* ไม่ได้แปลงใบ ทนพ. ให้ทำหัตถการที่อยู่นอกขอบเขต · ⚠️ MT **เก็บ specimen เชิงรุกได้ในขอบเขต** (เจาะ venous/capillary, swab) — เส้นคือหัตถการรุกล้ำที่ระเบียบไม่ครอบ เช่น ใส่สายสวน/สวนปัสสาวะ, เก็บทาง rectal เชิงรุก · **อย่าเหมา "rectal swab" = "ล้วงทวาร (digital)" เป็นก้อนเดียว** — แยกระดับการรุกล้ำ + **ตรวจข้อบังคับสภาฯ/ระเบียบหน่วยงานล่าสุดก่อนฟันธง** (ไม่ใช่คำวินิจฉัยกฎหมายตายตัว) · ถ้าอยู่นอกขอบเขต → **ไม่ทำเอง + escalate + จัดผู้มีอำนาจเก็บแทน** (อย่าปฏิเสธลอยจน specimen ค้าง) · *"ในสถานพยาบาล + มีคำสั่งแพทย์" ตอบแค่มุม พรบ.สถานพยาบาล ไม่ตอบมุมขอบเขต MT*
